...
| `less` | `less` | `less` `4.6.7` | `LESS-012`; canonical row verified |
...
Executable plugin/JavaScript/package/remote fixtures and official cases that intentionally emit invalid or environment-specific CSS are excluded by named policy rather than counted as passes. `PRE-005`, `PRE-006`, and `PRE-008` graduate `.less` through the 0.5 npm CLI/API after product, package, platform, batch/watch, consumer, and documentation gates. Canonical Less 4.6.7 support does not imply plugin, JavaScript, custom file-manager, or future-version parity.
