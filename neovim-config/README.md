...
> Experimental: this configuration launches the ZigCSS 0.3 language server. It does not install or bundle a native binary, scan the filesystem, or enable unavailable preprocessor support.
...
- A trusted ZigCSS 0.3.0 executable built from this source tree
