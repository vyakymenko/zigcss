...
> Experimental: this configuration launches the ZigCSS 0.4.0-rc.2 language server. It does not install or bundle a native binary, scan the filesystem, or enable unavailable preprocessor support.
...
- A trusted ZigCSS 0.4.0-rc.2 executable built from this source tree
