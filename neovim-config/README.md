...
> Experimental: this configuration launches the ZigCSS 0.5.0-rc.1 language server. It does not install or bundle a native binary, scan the filesystem, or enable preprocessor filetypes.
...
- A trusted ZigCSS 0.5.0-rc.1 executable built from this source tree
