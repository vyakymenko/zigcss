...
describe('autonomous development operations', () => {
  ...
  test('single-lane supervisor pins the model and passes hermetic control tests', () => {
    ...
    expect(prompt).toContain('Only BENCH-007 remains')
    expect(prompt).toContain('follow DEVELOPMENT_PLAN.md section 19 exactly')
    expect(prompt).toContain('stable code controlled-benchmark-archive')
