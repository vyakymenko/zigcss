...
test('accepts the bounded native stylesheet implementation contract', () => {
  ...
  assert.deepEqual(contract.stylusConformance, {
    ...
    completedCaseCount: 199,
    remainingCaseCount: 147,
    terminalContract: {
      selectionDerived: true,
      successCaseCount: 326,
      errorCaseCount: 20,
      exactSuccessCount: 179,
      nonconformingSuccessCount: 147,
      exactSuccessCaseIdWyhash: 'fac0e8025f4a946a',
      deterministicRunsPerSuccessCase: 2,
      fuzzMutationsPerCase: 3,
      maxConcurrentCompilations: 4,
      evidenceTests: [
...
test('rejects widened, unpinned, or unevidenced native Stylus conformance progress', () => {
  for (const mutate of [
    ...
    contract => { contract.stylusConformance.completedCaseCount = 198 },
    contract => { contract.stylusConformance.remainingCaseCount = 148 },
    ...
    contract => { contract.stylusConformance.terminalContract.exactSuccessCount = 178 },
    contract => { contract.stylusConformance.terminalContract.nonconformingSuccessCount = 148 },
    contract => { contract.stylusConformance.terminalContract.exactSuccessCaseIdWyhash = 'fac0e8025f4a946b' },
