...
test('rejects widened, unpinned, or unevidenced native Stylus conformance progress', () => {
  for (const mutate of [
    ...
    contract => { contract.stylusConformance.completedCaseCount = 204 },
    contract => { contract.stylusConformance.remainingCaseCount = 142 },
    ...
    contract => { contract.stylusConformance.terminalContract.exactSuccessCount = 184 },
    contract => { contract.stylusConformance.terminalContract.nonconformingSuccessCount = 142 },
    contract => { contract.stylusConformance.terminalContract.exactSuccessCaseIdWyhash = '653eebfbaba42d24' },
