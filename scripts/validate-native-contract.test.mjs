...
test('accepts the bounded native stylesheet implementation contract', () => {
  ...
  assert.deepEqual(contract.stylusConformance, {
    ...
    completedCaseCount: 186,
    remainingCaseCount: 160,
    terminalContract: {
      selectionDerived: true,
      successCaseCount: 326,
      errorCaseCount: 20,
      exactSuccessCount: 166,
      nonconformingSuccessCount: 160,
      exactSuccessCaseIdWyhash: 'cf1a5eefdb5f2119',
      deterministicRunsPerSuccessCase: 2,
      fuzzMutationsPerCase: 3,
      maxConcurrentCompilations: 4,
      evidenceTests: [
...
test('rejects widened, unpinned, or unevidenced native Stylus conformance progress', () => {
  for (const mutate of [
    ...
    contract => { contract.stylusConformance.completedCaseCount = 185 },
    contract => { contract.stylusConformance.remainingCaseCount = 161 },
    ...
    contract => { contract.stylusConformance.terminalContract.exactSuccessCount = 165 },
    contract => { contract.stylusConformance.terminalContract.nonconformingSuccessCount = 161 },
