...
test('accepts the bounded native stylesheet implementation contract', () => {
  ...
  assert.deepEqual(contract.stylusConformance, {
    ...
    completedCaseCount: 198,
    remainingCaseCount: 148,
    terminalContract: {
      selectionDerived: true,
      successCaseCount: 326,
      errorCaseCount: 20,
      exactSuccessCount: 178,
      nonconformingSuccessCount: 148,
      exactSuccessCaseIdWyhash: 'f6bdbc2afac421d6',
      deterministicRunsPerSuccessCase: 2,
      fuzzMutationsPerCase: 3,
      maxConcurrentCompilations: 4,
      evidenceTests: [
...
test('rejects widened, unpinned, or unevidenced native Stylus conformance progress', () => {
  for (const mutate of [
    ...
    contract => { contract.stylusConformance.completedCaseCount = 197 },
    contract => { contract.stylusConformance.remainingCaseCount = 149 },
    ...
    contract => { contract.stylusConformance.terminalContract.exactSuccessCount = 177 },
    contract => { contract.stylusConformance.terminalContract.nonconformingSuccessCount = 149 },
    contract => { contract.stylusConformance.terminalContract.exactSuccessCaseIdWyhash = 'f6bdbc2afac421d7' },
