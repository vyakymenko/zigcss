...
test('accepts the bounded native stylesheet implementation contract', () => {
  ...
  assert.deepEqual(contract.stylusConformance, {
    ...
    completedCaseCount: 204,
    remainingCaseCount: 142,
    terminalContract: {
      selectionDerived: true,
      successCaseCount: 326,
      errorCaseCount: 20,
      exactSuccessCount: 184,
      nonconformingSuccessCount: 142,
      exactSuccessCaseIdWyhash: '04aeb0b29da6e111',
      deterministicRunsPerSuccessCase: 2,
      fuzzMutationsPerCase: 3,
      maxConcurrentCompilations: 4,
      evidenceTests: [
...
test('rejects widened, unpinned, or unevidenced native Stylus conformance progress', () => {
  for (const mutate of [
    ...
    contract => { contract.stylusConformance.completedCaseCount = 203 },
    contract => { contract.stylusConformance.remainingCaseCount = 143 },
    ...
    contract => { contract.stylusConformance.terminalContract.exactSuccessCount = 183 },
    contract => { contract.stylusConformance.terminalContract.nonconformingSuccessCount = 143 },
    contract => { contract.stylusConformance.terminalContract.exactSuccessCaseIdWyhash = '04aeb0b29da6e110' },
