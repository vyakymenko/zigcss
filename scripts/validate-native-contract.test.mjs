...
test('accepts the bounded native stylesheet implementation contract', () => {
  ...
  assert.deepEqual(contract.stylusConformance, {
    ...
    completedCaseCount: 208,
    remainingCaseCount: 138,
    terminalContract: {
      selectionDerived: true,
      successCaseCount: 326,
      errorCaseCount: 20,
      exactSuccessCount: 188,
      nonconformingSuccessCount: 138,
      exactSuccessCaseIdWyhash: 'eb76679398ae9744',
      deterministicRunsPerSuccessCase: 2,
      fuzzMutationsPerCase: 3,
      maxConcurrentCompilations: 4,
      evidenceTests: [
...
test('rejects widened, unpinned, or unevidenced native Stylus conformance progress', () => {
  for (const mutate of [
    ...
    contract => { contract.stylusConformance.completedCaseCount = 207 },
    contract => { contract.stylusConformance.remainingCaseCount = 139 },
    ...
    contract => { contract.stylusConformance.terminalContract.exactSuccessCount = 187 },
    contract => { contract.stylusConformance.terminalContract.nonconformingSuccessCount = 139 },
    contract => { contract.stylusConformance.terminalContract.exactSuccessCaseIdWyhash = 'eb76679398ae9745' },
