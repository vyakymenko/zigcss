...
test('accepts the bounded native stylesheet implementation contract', () => {
  ...
  assert.deepEqual(contract.stylusConformance, {
    ...
    completedCaseCount: 206,
    remainingCaseCount: 140,
    terminalContract: {
      selectionDerived: true,
      successCaseCount: 326,
      errorCaseCount: 20,
      exactSuccessCount: 186,
      nonconformingSuccessCount: 140,
      exactSuccessCaseIdWyhash: '982bd82e665c42ed',
      deterministicRunsPerSuccessCase: 2,
      fuzzMutationsPerCase: 3,
      maxConcurrentCompilations: 4,
      evidenceTests: [
...
test('rejects widened, unpinned, or unevidenced native Stylus conformance progress', () => {
  for (const mutate of [
    ...
    contract => { contract.stylusConformance.completedCaseCount = 205 },
    contract => { contract.stylusConformance.remainingCaseCount = 141 },
    ...
    contract => { contract.stylusConformance.terminalContract.exactSuccessCount = 185 },
    contract => { contract.stylusConformance.terminalContract.nonconformingSuccessCount = 141 },
    contract => { contract.stylusConformance.terminalContract.exactSuccessCaseIdWyhash = '982bd82e665c42ec' },
