...
test('accepts the bounded native stylesheet implementation contract', () => {
  ...
  assert.deepEqual(contract.stylusConformance, {
    ...
    completedCaseCount: 203,
    remainingCaseCount: 143,
    terminalContract: {
      selectionDerived: true,
      successCaseCount: 326,
      errorCaseCount: 20,
      exactSuccessCount: 183,
      nonconformingSuccessCount: 143,
      exactSuccessCaseIdWyhash: '1b0e50ebf29bd9a9',
      deterministicRunsPerSuccessCase: 2,
      fuzzMutationsPerCase: 3,
      maxConcurrentCompilations: 4,
      evidenceTests: [
...
test('rejects widened, unpinned, or unevidenced native Stylus conformance progress', () => {
  for (const mutate of [
    ...
    contract => { contract.stylusConformance.completedCaseCount = 202 },
    contract => { contract.stylusConformance.remainingCaseCount = 144 },
    ...
    contract => { contract.stylusConformance.terminalContract.exactSuccessCount = 182 },
    contract => { contract.stylusConformance.terminalContract.nonconformingSuccessCount = 144 },
    contract => { contract.stylusConformance.terminalContract.exactSuccessCaseIdWyhash = '1b0e50ebf29bd9a8' },
