...
test('accepts the bounded native stylesheet implementation contract', () => {
  ...
  assert.deepEqual(contract.stylusConformance, {
    ...
    completedCaseCount: 194,
    remainingCaseCount: 152,
    terminalContract: {
      selectionDerived: true,
      successCaseCount: 326,
      errorCaseCount: 20,
      exactSuccessCount: 174,
      nonconformingSuccessCount: 152,
      exactSuccessCaseIdWyhash: '513ebfcbc79ae67c',
      deterministicRunsPerSuccessCase: 2,
      fuzzMutationsPerCase: 3,
      maxConcurrentCompilations: 4,
      evidenceTests: [
...
test('rejects widened, unpinned, or unevidenced native Stylus conformance progress', () => {
  for (const mutate of [
    ...
    contract => { contract.stylusConformance.completedCaseCount = 193 },
    contract => { contract.stylusConformance.remainingCaseCount = 153 },
    ...
    contract => { contract.stylusConformance.terminalContract.exactSuccessCount = 173 },
    contract => { contract.stylusConformance.terminalContract.nonconformingSuccessCount = 153 },
    contract => { contract.stylusConformance.terminalContract.exactSuccessCaseIdWyhash = 'f6b072dd47336d0e' },
