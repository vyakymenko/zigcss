...
test('accepts the bounded native stylesheet implementation contract', () => {
  ...
  assert.deepEqual(contract.stylusConformance, {
    ...
    completedCaseCount: 185,
    remainingCaseCount: 161,
    terminalContract: {
      selectionDerived: true,
      successCaseCount: 326,
      errorCaseCount: 20,
      exactSuccessCount: 165,
      nonconformingSuccessCount: 161,
      exactSuccessCaseIdWyhash: 'f6b072dd47336d0e',
      deterministicRunsPerSuccessCase: 2,
      fuzzMutationsPerCase: 3,
      maxConcurrentCompilations: 4,
      evidenceTests: [
...
test('rejects widened, unpinned, or unevidenced native Stylus conformance progress', () => {
  for (const mutate of [
    ...
    contract => { contract.stylusConformance.completedCaseCount = 184 },
    contract => { contract.stylusConformance.remainingCaseCount = 162 },
    ...
    contract => { contract.stylusConformance.terminalContract.exactSuccessCount = 164 },
    contract => { contract.stylusConformance.terminalContract.nonconformingSuccessCount = 162 },
    contract => { contract.stylusConformance.terminalContract.exactSuccessCaseIdWyhash = 'f0d3f1294f4f10df' },
