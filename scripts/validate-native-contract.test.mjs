...
test('accepts the bounded native stylesheet implementation contract', () => {
  ...
  assert.deepEqual(contract.stylusConformance, {
    ...
    completedCaseCount: 212,
    remainingCaseCount: 134,
    terminalContract: {
      selectionDerived: true,
      successCaseCount: 326,
      errorCaseCount: 20,
      exactSuccessCount: 192,
      nonconformingSuccessCount: 134,
      exactSuccessCaseIdWyhash: '7146b1a62ee0a431',
      deterministicRunsPerSuccessCase: 2,
      fuzzMutationsPerCase: 3,
      maxConcurrentCompilations: 4,
      evidenceTests: [
...
test('rejects widened, unpinned, or unevidenced native Stylus conformance progress', () => {
  for (const mutate of [
    ...
    contract => { contract.stylusConformance.completedCaseCount = 208 },
    contract => { contract.stylusConformance.remainingCaseCount = 138 },
    ...
    contract => { contract.stylusConformance.terminalContract.exactSuccessCount = 188 },
    contract => { contract.stylusConformance.terminalContract.nonconformingSuccessCount = 138 },
    contract => { contract.stylusConformance.terminalContract.exactSuccessCaseIdWyhash = '4bb07d3fd45709ee' },
