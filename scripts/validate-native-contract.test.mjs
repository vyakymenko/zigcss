...
test('accepts the bounded native stylesheet implementation contract', () => {
  ...
  assert.deepEqual(contract.stylusConformance, {
    ...
    completedCaseCount: 202,
    remainingCaseCount: 144,
    terminalContract: {
      selectionDerived: true,
      successCaseCount: 326,
      errorCaseCount: 20,
      exactSuccessCount: 182,
      nonconformingSuccessCount: 144,
      exactSuccessCaseIdWyhash: '1893b54c0067f3f3',
      deterministicRunsPerSuccessCase: 2,
      fuzzMutationsPerCase: 3,
      maxConcurrentCompilations: 4,
      evidenceTests: [
...
test('rejects widened, unpinned, or unevidenced native Stylus conformance progress', () => {
  for (const mutate of [
    ...
    contract => { contract.stylusConformance.completedCaseCount = 201 },
    contract => { contract.stylusConformance.remainingCaseCount = 145 },
    ...
    contract => { contract.stylusConformance.terminalContract.exactSuccessCount = 181 },
    contract => { contract.stylusConformance.terminalContract.nonconformingSuccessCount = 145 },
    contract => { contract.stylusConformance.terminalContract.exactSuccessCaseIdWyhash = '1893b54c0067f3f2' },
