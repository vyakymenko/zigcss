...
const expectedImplementations = Object.freeze([
  ...
  Object.freeze({
    ...
    capabilities: Object.freeze([
      ...
      'local-use-forty-fourth-module-reexported-callable-configuration-ownership-foundation',
      'local-use-forty-fifth-module-reexported-callable-configuration-ownership-foundation',
      'local-use-forty-sixth-module-reexported-callable-configuration-ownership-foundation',
      ...
      'local-use-fifty-first-module-reexported-callable-configuration-ownership-foundation',
      'local-use-fifty-second-module-reexported-callable-configuration-ownership-foundation',
      'local-use-fifty-third-module-reexported-callable-configuration-ownership-foundation',
      'local-use-fifty-fourth-module-reexported-callable-configuration-ownership-foundation',
      'local-use-fifty-fifth-module-reexported-callable-configuration-ownership-foundation',
      'local-use-fifty-sixth-module-reexported-callable-configuration-ownership-foundation',
      'local-use-fifty-seventh-module-reexported-callable-configuration-ownership-foundation',
      'local-use-fifty-eighth-module-reexported-callable-configuration-ownership-foundation',
      'local-use-fifty-ninth-module-reexported-callable-configuration-ownership-foundation',
      'local-use-sixtieth-module-reexported-callable-configuration-ownership-foundation',
      'local-use-sixty-first-module-reexported-callable-configuration-ownership-foundation',
      'local-use-sixty-second-module-reexported-callable-configuration-ownership-foundation',
      'numeric-arithmetic',
