...
> Experimental: this client is not a stable editor package. CSS diagnostics and syntax-aware features use rebuilt compiler data, while extension packaging and binary discovery remain incomplete.
