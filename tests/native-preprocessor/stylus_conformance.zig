...
test "native Stylus measures the finite pinned success corpus without ordinal expansion" {
    ...
    if (exact_success_count != 307 or nonconforming_count != 19 or
        exact_hash != 0xc98601714db350e7)
    {
        std.debug.print(
    ...
    try std.testing.expectEqual(@as(usize, 307), exact_success_count);
    try std.testing.expectEqual(@as(usize, 19), nonconforming_count);
    try std.testing.expectEqual(@as(u64, 0xc98601714db350e7), exact_hash);
