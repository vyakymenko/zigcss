...
test "native Stylus measures the finite pinned success corpus without ordinal expansion" {
    ...
    if (exact_success_count != 284 or nonconforming_count != 42 or
        exact_hash != 0xd53dfca8c0cc9c18)
    {
        std.debug.print(
    ...
    try std.testing.expectEqual(@as(usize, 284), exact_success_count);
    try std.testing.expectEqual(@as(usize, 42), nonconforming_count);
    try std.testing.expectEqual(@as(u64, 0xd53dfca8c0cc9c18), exact_hash);
