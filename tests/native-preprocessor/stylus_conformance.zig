...
test "native Stylus measures the finite pinned success corpus without ordinal expansion" {
    ...
    if (exact_success_count != 318 or nonconforming_count != 8 or
        exact_hash != 0x4d8e91e47115798a)
    {
        std.debug.print(
    ...
    try std.testing.expectEqual(@as(usize, 318), exact_success_count);
    try std.testing.expectEqual(@as(usize, 8), nonconforming_count);
    try std.testing.expectEqual(@as(u64, 0x4d8e91e47115798a), exact_hash);
