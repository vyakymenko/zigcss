...
test "native Stylus measures the finite pinned success corpus without ordinal expansion" {
    ...
    if (exact_success_count != 315 or nonconforming_count != 11 or
        exact_hash != 0xa09332be4223b1f4)
    {
        std.debug.print(
    ...
    try std.testing.expectEqual(@as(usize, 315), exact_success_count);
    try std.testing.expectEqual(@as(usize, 11), nonconforming_count);
    try std.testing.expectEqual(@as(u64, 0xa09332be4223b1f4), exact_hash);
