...
test "native Stylus measures the finite pinned success corpus without ordinal expansion" {
    ...
    if (exact_success_count != 287 or nonconforming_count != 39 or
        exact_hash != 0xe0b56e842fd969e5)
    {
        std.debug.print(
    ...
    try std.testing.expectEqual(@as(usize, 287), exact_success_count);
    try std.testing.expectEqual(@as(usize, 39), nonconforming_count);
    try std.testing.expectEqual(@as(u64, 0xe0b56e842fd969e5), exact_hash);
