...
test "native Stylus measures the finite pinned success corpus without ordinal expansion" {
    ...
    if (exact_success_count != 291 or nonconforming_count != 35 or
        exact_hash != 0x7fd5cc165683f885)
    {
        std.debug.print(
    ...
    try std.testing.expectEqual(@as(usize, 291), exact_success_count);
    try std.testing.expectEqual(@as(usize, 35), nonconforming_count);
    try std.testing.expectEqual(@as(u64, 0x7fd5cc165683f885), exact_hash);
