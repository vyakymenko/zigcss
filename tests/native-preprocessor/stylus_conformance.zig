...
test "native Stylus measures the finite pinned success corpus without ordinal expansion" {
    ...
    if (exact_success_count != 290 or nonconforming_count != 36 or
        exact_hash != 0x2076ad4dd3a15b28)
    {
        std.debug.print(
    ...
    try std.testing.expectEqual(@as(usize, 290), exact_success_count);
    try std.testing.expectEqual(@as(usize, 36), nonconforming_count);
    try std.testing.expectEqual(@as(u64, 0x2076ad4dd3a15b28), exact_hash);
