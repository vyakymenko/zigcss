...
test "native Stylus measures the finite pinned success corpus without ordinal expansion" {
    ...
    if (exact_success_count != 308 or nonconforming_count != 18 or
        exact_hash != 0x6139ca6a6f2b853e)
    {
        std.debug.print(
    ...
    try std.testing.expectEqual(@as(usize, 308), exact_success_count);
    try std.testing.expectEqual(@as(usize, 18), nonconforming_count);
    try std.testing.expectEqual(@as(u64, 0x6139ca6a6f2b853e), exact_hash);
